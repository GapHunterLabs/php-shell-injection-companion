package dev.gaphunter.phpshellinjectioncompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.phpshellinjectioncompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.phpshellinjectioncompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "PHP Shell Injection Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33892-php-shell-injection-companion/reviews"
